...
- (void)mouseDown:(NSEvent *)event {
    ...
    Axiom::MouseButtonPressedEvent mouseEvent(Axiom::macOSMouseButtonToAxiomMouseButton([event buttonNumber]), x, flippedY);
...
- (void)mouseUp:(NSEvent *)event {
    ...
    Axiom::MouseButtonReleasedEvent mouseEvent(Axiom::macOSMouseButtonToAxiomMouseButton([event buttonNumber]), x, flippedY);
    _wData->eventCallback(mouseEvent);
}
